...
from .federared_connection.federated_connection_authorizer import FederatedConnectionAuthorizer, FederatedConnectionAuthorizerParams
...
class Auth0AI():
    ...
    def with_federated_connection(self, options: FederatedConnectionAuthorizerParams) -> CIBAGraph:
        """
        ...
        """
        authorizer = FederatedConnectionAuthorizer(self.config, options)
